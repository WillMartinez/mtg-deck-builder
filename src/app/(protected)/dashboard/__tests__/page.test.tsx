...
describe('DashboardPage', () => {
  ...
  it('displays placeholder text for decks', () => {
    ...
    expect(screen.getByText('Your Commander decks will appear here soon...')).toBeInTheDocument();
  });
  ...
  it('applies correct styling to deck section', () => {
    ...
    const deckSection = container.querySelector('.bg-white.shadow-md.rounded.p-6');
    expect(deckSection).toBeInTheDocument();
    expect(deckSection).toHaveTextContent('Your Decks');
    expect(deckSection).toHaveTextContent('Your Commander decks will appear here soon...');
  });
});
